...
# Keep CrewAI's local cache inside the project so Windows AppData permissions
# do not prevent the API from starting in local/dev environments.
os.environ["LOCALAPPDATA"] = os.path.abspath(os.path.join(_BASE, "..", ".local"))
os.environ["CREWAI_STORAGE_DIR"] = os.path.abspath(
    os.path.join(_BASE, "..", ".crewai_storage")
)
